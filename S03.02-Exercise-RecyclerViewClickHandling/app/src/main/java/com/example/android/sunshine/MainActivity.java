...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler{
    ...
    @Override
    public void onClick(String clickString) {
        if (mToastWeather != null){
            mToastWeather.cancel();
        }
        mToastWeather = Toast.makeText(context,"Weather Data "+clickString,Toast.LENGTH_SHORT);
        mToastWeather.show();
    }
